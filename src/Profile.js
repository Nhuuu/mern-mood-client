    ...
    if(this.props.user){
      ...
      return (
        <div className="overall-style">
          <h3 className="prof-style">Hello again, <i>{this.firstCapitalization(this.props.user.name)}</i> !</h3>
          <h4 className="prof-style">Your email is <b>{this.props.user.email}</b></h4>
          <h4 className="prof-style">Your current location is <b>{this.props.user.location.toUpperCase()}</b></h4>
